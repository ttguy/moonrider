...
use node verson manager to install v11 of node
nvm install 11.15.0
nvm use 11.15.0
...
Then head to `localhost:3001` in your browser.

This version has changes in webpack.config.js  to make it accessible on ttguys https://yahwehsflatearth.com:3001/
